...
Thanks for using rpisco! Before filing an issue, there are a few places
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/pefrens/rpisco/issues/new).
...
requests](https://github.com/pefrens/rpisco/issues) to make sure the bug
