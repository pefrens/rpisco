...
This outlines how to propose a change to rpisco. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("pefrens/rpisco", fork = TRUE)`.
...
Please note that the rpisco project is released with a [Contributor Code
of Conduct](https://pefrens.github.io/rpisco/CODE_OF_CONDUCT.md). By
